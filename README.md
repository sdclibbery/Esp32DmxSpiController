...
...Modes that interp0late with hsv? or lablch? or all should???
... gamma correction??
...
2. Solid: Blend entire strip through the palette based on control, smoothing applies a curved palette profile
...
5. Noise: Perlin noise. Control is seed. Smoothing is scale
