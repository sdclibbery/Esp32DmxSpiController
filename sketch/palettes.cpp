...
Rgb palette(uint8_t type, const Rgb& back, const Rgb& fore, float lerp, float dt) {
  ...
  switch (type) {
    ...
    case 30: return gamma(blendScaledSum(back, fore, lerp));
    case 31: return gamma(blend3(off, back, fore, lerp, &blendScaledSum));
    case 32: return gamma(blend3(back, fore, off, lerp, &blendScaledSum));
    case 33: return gamma(blend3(back, off, fore, lerp, &blendScaledSum));
    case 34: return gamma(blend3(off, fore, back, lerp, &blendScaledSum));
    case 35: return gamma(blend4(back, fore, back, fore, lerp, &blendScaledSum));
    case 36: return gamma(blend6(back, fore, back, fore, back, fore, lerp, &blendScaledSum));
    case 37: return gamma(blend5(off, back, fore, back, fore, lerp, &blendScaledSum));
    case 38: return gamma(blend7(off, back, fore, back, fore, back, fore, lerp, &blendScaledSum));

    case 40: return gamma(blendSub(back, fore, lerp));
    case 41: return gamma(blend3(off, back, fore, lerp, &blendSub));
    case 42: return gamma(blend3(back, fore, off, lerp, &blendSub));
    case 43: return gamma(blend3(back, off, fore, lerp, &blendSub));
    case 44: return gamma(blend3(off, fore, back, lerp, &blendSub));
    case 45: return gamma(blend4(back, fore, back, fore, lerp, &blendSub));
    ...
    case 102: return gamma(blend3(back, fore, off, lerp, &dither));
    case 103: return gamma(blend3(back, off, fore, lerp, &dither));
    case 104: return gamma(blend3(off, fore, back, lerp, &dither));
    case 105: return gamma(blend4(back, fore, back, fore, lerp, &dither));
    case 106: return gamma(blend6(back, fore, back, fore, back, fore, lerp, &dither));
    case 107: return gamma(blend5(off, back, fore, back, fore, lerp, &dither));
    case 108: return gamma(blend7(off, back, fore, back, fore, back, fore, lerp, &dither));

    case 110: return gamma(blendRgb(back, fore, fizzle(lerp)));
    case 111: return gamma(blend3(off, back, fore, fizzle(lerp), &blendRgb));
    case 112: return gamma(blend3(back, fore, off, fizzle(lerp), &blendRgb));
    case 113: return gamma(blend3(back, off, fore, fizzle(lerp), &blendRgb));
    case 114: return gamma(blend3(off, fore, back, fizzle(lerp), &blendRgb));
    case 115: return gamma(blend4(back, fore, back, fore, fizzle(lerp), &blendRgb));
    case 116: return gamma(blend6(back, fore, back, fore, back, fore, fizzle(lerp), &blendRgb));
    case 117: return gamma(blend5(off, back, fore, back, fore, fizzle(lerp), &blendRgb));
    case 118: return gamma(blend7(off, back, fore, back, fore, back, fore, fizzle(lerp), &blendRgb));

    case 120: return wizzle(gamma(blendRgb(back, fore, lerp)), dt);
    case 121: return wizzle(gamma(blend3(off, back, fore, lerp, &blendRgb)), dt);
    case 122: return wizzle(gamma(blend3(back, fore, off, lerp, &blendRgb)), dt);
    case 123: return wizzle(gamma(blend3(back, off, fore, lerp, &blendRgb)), dt);
    case 124: return wizzle(gamma(blend3(off, fore, back, lerp, &blendRgb)), dt);
    case 125: return wizzle(gamma(blend4(back, fore, back, fore, lerp, &blendRgb)), dt);
    case 126: return wizzle(gamma(blend6(back, fore, back, fore, back, fore, lerp, &blendRgb)), dt);
    case 127: return wizzle(gamma(blend5(off, back, fore, back, fore, lerp, &blendRgb)), dt);
    case 128: return wizzle(gamma(blend7(off, back, fore, back, fore, back, fore, lerp, &blendRgb)), dt);
